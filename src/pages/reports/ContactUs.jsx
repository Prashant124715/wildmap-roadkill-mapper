...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 relative bg-brand-dark">
      ...
      <div className="absolute inset-0 z-0 bg-cover bg-center bg-fixed opacity-30 transition-opacity duration-1000 pointer-events-none" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=1920')` }}></div>
